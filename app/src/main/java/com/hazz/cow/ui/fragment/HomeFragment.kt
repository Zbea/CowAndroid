...
import com.hazz.cow.ui.activity.asset.ExtractCoinActivity
import com.hazz.cow.ui.activity.home.*
import com.hazz.cow.ui.activity.home.investment.InvestmentActivity
import com.hazz.cow.ui.activity.mine.MineCertificationActivity
import com.hazz.cow.ui.adapter.HomeAdapter
...
import kotlinx.android.synthetic.main.fragment_new_home.iv_msg
import kotlinx.android.synthetic.main.fragment_new_home.toolbar
...
class HomeFragment : BaseFragment(), IContractView.HomeView, IContractView.MsgView, IContractView.ICertificationInfoView {
    ...
    override fun initView() {
        ...
        mAdapter?.setOnItemClickListener { _, _, position ->
            startActivity(Intent(context, HomeRentNewActivity::class.java).putExtra("produce", home?.products?.get(position)))
        }
    ...
    private fun initBanner(list: List<String>) {
        banner?.run {
            ...
            layoutParams1.height = (DisplayManager.getScreenWidth()?.times(175))?.div(375)!!
