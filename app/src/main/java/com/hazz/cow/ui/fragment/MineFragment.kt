...
import com.hazz.cow.mvp.presenter.NodePresenter
import com.hazz.cow.ui.activity.*
import com.hazz.cow.ui.activity.asset.IncomingActivity
import com.hazz.cow.ui.activity.home.investment.InvestmentActivity
import com.hazz.cow.ui.activity.mine.*
import com.hazz.cow.utils.*
import com.hazz.cow.widget.PhotoDialog
...
class MineFragment : BaseFragment(), IContractView.NodeView {
    ...
    override fun getAccount(msg: Account) {
        ...
        when (msg.level_num) {
            "1" -> iv_type.setImageResource(R.mipmap.icon_mine_level_km)
            "2" -> iv_type.setImageResource(R.mipmap.icon_mine_level_kg)
            "3" -> iv_type.setImageResource(R.mipmap.icon_mine_level_kz)
            "4" -> iv_type.setImageResource(R.mipmap.icon_mine_level_ks)
            "5" -> iv_type.setImageResource(R.mipmap.icon_mine_level_super)
